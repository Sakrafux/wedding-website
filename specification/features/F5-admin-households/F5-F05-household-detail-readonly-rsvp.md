...
1. The three fields are answers, not settings. Editing them here bypassed the RSVP rules (`F5-B05`), and showing them beside the household's own name fields invited exactly that. They move into the RSVP section, next to the link that edits them properly, and read as "—" when nothing was answered.
