...
- **Transparency.** A short German "Datenschutz" page states in plain language: what we store, why, who sees it, how long, and how to reach us to change or delete it. Written in the same informal register as the rest of the site — a wall of legalese would be worse than nothing here. It sits **behind the household login**, with the other content pages. It was specified as readable without logging in, on the grounds that a notice you have to authenticate to read is not a notice; reversed on 2026-08-31 once the page existed. Nobody without a code has any data described on it, the audience is eighty invited guests who are logged in at the moment they hand us the data, and a page that rendered without the site's navigation read as a different site. The invitation is not public, and neither is the notice about it.
